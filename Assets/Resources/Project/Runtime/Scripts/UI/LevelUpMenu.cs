...
using UDPU = Resources.Project.Runtime.Scripts.UI.UpgradesDatabase.PowerUps;
using UD = Resources.Project.Runtime.Scripts.UI.UpgradesDatabase;
...
namespace Resources.Project.Runtime.Scripts.UI
{
    ...
    //         {
    //             Random.InitState((int) DateTime.Now.Ticks);
    //             secondOption = Random.Range(UD.EffectsBottomIndex, UD.EffectsTopIndex + 1);
    //         } while (firstOption == secondOption);
    //         options.Add((UDPU) secondOption);
    //         
    //         // Third option (Mechanical)
    //         Random.InitState((int) DateTime.Now.Ticks);
    //         var thirdOption = Random.Range(UD.MechanicalBottomIndex, UD.MechanicalTopIndex + 1);
    //         options.Add((UDPU) thirdOption);
    //         
    //         // Fourth option (Stats)
    //         Random.InitState((int) DateTime.Now.Ticks);
    //         var fourthOption = Random.Range(UD.StatsBottomIndex, UD.StatsTopIndex + 1);
